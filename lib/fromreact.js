 ...
 var LeaveWordTool = React.createClass({displayName: "LeaveWordTool",
	...
	handleSubmit: function () {
		if(this.props.userstatus){
			...
			$.openModal('<iframe src="https://changyan.sohu.com/api/oauth2/authorize?client_id=cyrCA2YHb&redirect_uri=http://yansm.github.io/fromone/checkOAUTH.html&response_type=code&platform_id=3"> ');
		}
	},
	...
	render: function () {
		return (
			React.createElement("div", {className: "comment-login-area fix"}, 
				React.createElement("div", {className: "comment-login-item", onClick: this.clickSohu}, 
					React.createElement("div", {className: "comment-login-icon comment-login-sohu"}), "搜狐登录"
				), 
				React.createElement("div", {className: "comment-login-item", onClick: this.clickQQ}, 
					React.createElement("div", {className: "comment-login-icon comment-login-QQ"}), "QQ登录"
				), 
				React.createElement("div", {className: "comment-login-item", onClick: this.clickWeibo}, 
